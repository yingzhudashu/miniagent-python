...
| `MINIAGENT_CLI_STYLES_THINK_HEAD` | `ansibrightcyan` | CLI 思考标题样式（prompt_toolkit ANSI 格式） |
| `MINIAGENT_CLI_STYLES_THINK_BODY` | `ansibrightcyan` | CLI 思考正文样式 |
...
| `MINIAGENT_FEATURES_CONFIG_HOT_RELOAD` | `0` | 配置文件热更新：监听 `config.user.json` 修改并自动重载 |
