...
class SandboxViolationError(Exception):
    ...
    由 ``miniagent.agent.workspace.resolve_sandbox_path`` 在路径校验失败时抛出。
...
class FeishuConfigMissingError(Exception):
    ...
    See also:
        ``miniagent.assistant.tools.feishu_utils.require_feishu_config``
    """
...
class LarkOapiMissingError(Exception):
    ...
    See also:
        ``miniagent.assistant.tools.feishu_utils.require_lark_oapi_installed``
    """
