...
from miniagent.contracts.llm import LLMProvider, ProviderConfig
from miniagent.infrastructure.llm.catalog import ModelCatalog, RoleRouter, model_from_config
from miniagent.infrastructure.llm.gateway import LLMGateway, ProviderRegistry
from miniagent.infrastructure.llm.providers import (
    AnthropicProvider,
    GoogleProvider,
    OpenAIProvider,
)
...
def create_llm_gateway(
    ...
    *,
    ...
    from miniagent.infrastructure.llm.catalog_cache import load_catalog_cache
