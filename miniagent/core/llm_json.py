...
async def _request_json_once(
    ...
    *,
    ...
    try:
        response = (
            await create_structured_completion(client, messages=json_messages, params=params)
            if use_json_object
            else await create_completion(client, messages=base_messages, params=params)
        )
    ...
    try:
        response = await create_completion(client, messages=base_messages, params=params)
    except Exception as error:
