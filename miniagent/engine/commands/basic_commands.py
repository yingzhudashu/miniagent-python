...
async def handle_status(
    ...
    **_kwargs: Any,
    ...
    """显示当前 Agent、会话和队列状态。"""
    from miniagent.engine.command_dispatch import _format_status
...
async def handle_help(
    ...
    **_kwargs: Any,
    ...
    """从命令元数据生成并显示帮助。"""
    from miniagent.engine.cli_commands import cmd_help
...
async def handle_schedule(
    ...
    **_kwargs: Any,
    ...
    from miniagent.engine.cli_commands import cmd_schedule, feishu_dot_commands_full_enabled
