...
def _validate_next_run(task: Any, *, new_task: bool) -> str | None:
    ...
    from miniagent.scheduled_tasks.store import compute_initial_next_run
...
def _schedule_add(raw: str) -> str:
    ...
    from miniagent.scheduled_tasks.store import format_next_run_display, load_tasks, save_tasks
