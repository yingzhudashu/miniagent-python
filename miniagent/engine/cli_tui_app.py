...
class _TuiApplication:
    ...
    def stream_state(self, session_key: str = "") -> Any:
        ...
        from miniagent.engine.cli_tui import _StreamingThinkState
    ...
    def skill_prompt_snapshot(self) -> str | None:
        """优先返回热加载状态中的技能提示拼接文本。"""
        from miniagent.skills.snapshots import get_skill_prompts_from_state, join_skill_prompts
    ...
    def setup_messaging(self) -> None:
        ...
        from miniagent.engine.cli_inbound import CLI_CONVERSATION_ID
    ...
    def setup_input_and_transcript(self) -> None:
        ...
        from miniagent.engine.cli_completion import create_cli_completer
        from miniagent.engine.cli_tui import _TuiViewport
        from miniagent.engine.command_registry import COMMAND_REGISTRY
    ...
    def markdown_width(self) -> int:
        ...
        from miniagent.engine.cli_transcript import markdown_render_width
    ...
    def setup_transcript_operations(self) -> None:
        ...
        from miniagent.engine.cli_transcript import is_valid_pt_style, safe_ansi_fragments
    ...
    def setup_controls_and_appenders(self) -> None:
        ...
        from miniagent.engine.cli_transcript import is_valid_pt_style
        from miniagent.engine.cli_tui_appenders import create_transcript_appenders
        from miniagent.engine.cli_tui_controls import create_transcript_controls
    ...
    def setup_output_and_turn(self) -> None:
        ...
        from miniagent.contracts.messages import OutboundEventKind
        from miniagent.engine.cli_inbound import build_cli_inbound_message
        from miniagent.engine.cli_outbound import (
            CliChannelAdapter,
            build_cli_outbound_event,
            build_cli_thinking_event,
        )
        from miniagent.engine.cli_transcript import rule_line_width
        from miniagent.engine.cli_tui_output import create_tui_output_bindings
...
async def run_fullscreen_cli(
    ...
    *,
    ...
    from miniagent.engine.cli_tui import _run_tui_interaction
