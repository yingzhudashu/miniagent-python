...
安装 ``pip install miniagent-python[mcp]`` 后可通过 :mod:`miniagent.assistant.mcp.bridge` 连接 stdio 服务端
...
from miniagent.assistant.mcp.runtime import close_mcp_connections, register_mcp_stdio_tools
from miniagent.assistant.mcp.toolbox import MCP_TOOLBOX, ensure_mcp_toolbox, registry_has_mcp_tools
