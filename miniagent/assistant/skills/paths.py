...
def get_packaged_skills_root() -> str:
    """Return the immutable baseline skill packages shipped with MiniAgent."""
...
def get_all_skill_roots(*, include_sessions: bool = True) -> list[str]:
    ...
    """
    roots: list[str] = [get_packaged_skills_root(), get_skills_root()]
