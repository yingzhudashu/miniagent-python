...
``miniagent.assistant.engine.main``；架构背景见 ``docs/ARCHITECTURE.md``（消息队列与双通道）。

**与 ChannelRouter 的关系**：飞书入站经 :class:`miniagent.assistant.infrastructure.channel_router.ChannelRouter`
