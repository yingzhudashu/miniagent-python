...
使用方式：
    from miniagent.assistant.engine.commands.config_commands import feishu_dot_commands_full_enabled
"""

from __future__ import annotations

from miniagent.assistant.infrastructure.json_config import get_config_bool
from miniagent.assistant.testing.types import DEFAULT_SAMPLES_DIR
