...
def append_markdown_to_document_with_stats(
    ...
    *,
    ...
    if use_renderer:
        try:
            from miniagent.assistant.feishu.docx.markdown_renderer import markdown_to_feishu_blocks
...
_logger = logging.getLogger("miniagent.assistant.feishu.docx.blocks")
