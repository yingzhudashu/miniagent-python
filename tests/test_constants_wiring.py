...
from miniagent.agent.agent import _clarifier_max_questions_for_difficulty
...
def test_history_archive_default_from_constant(monkeypatch) -> None:
    monkeypatch.setattr(
        "miniagent.assistant.memory.history_archive.get_config",
...
def test_cli_thinking_rich_env_override(monkeypatch) -> None:
    from miniagent.assistant.engine.thinking import _cli_thinking_rich_enabled
