...
class TestReflectOnResult:
    ...
    async def test_reflect_on_result_preserves_single_quality_score(self):
        with patch(
            "miniagent.agent.problem_solver.llm_json",
            new_callable=AsyncMock,
        ) as mock_llm:
            mock_llm.return_value = {"acceptable": True, "quality_score": 0.85}
