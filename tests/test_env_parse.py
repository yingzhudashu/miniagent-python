"""``miniagent.assistant.infrastructure.env_parse`` 单元测试。"""
...
def test_env_str_and_choice(monkeypatch: pytest.MonkeyPatch) -> None:
    from miniagent.assistant.infrastructure.env_parse import env_choice, env_str
...
def test_env_flag_strict_unknown_is_false(monkeypatch: pytest.MonkeyPatch) -> None:
    from miniagent.assistant.infrastructure.env_parse import env_flag_strict
